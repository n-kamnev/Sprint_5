...
class StellaBurgersLocators:
    ...
    INCORRECT_PASSWORD_INSCRIPTION = (By.XPATH, ".//p[@class='input__error text_type_main-default']")  # "Неккоретный пароль"
    ...
    LOGIN_BUTTON_IN_RESTORE_PASSWORD = (By.XPATH, "//a[text()= 'Войти']")  # кнопка "Войти" - восстановления пароля
    LOGIN_BUTTON_IN_REGISTRATION_FORM = (By.XPATH, "//a[text()= 'Войти']")  # кнопка "Войти" в форме регистрации
    CONFIRM_REGISTRATION_BUTTON = (By.XPATH, "//button[text()= 'Зарегистрироваться']")  # подтверждения регистрации
