...
class TestSwitchingInConstructor:
    def test_switch_to_sauces_section(self, driver):
        ...
        WebDriverWait(driver, 3).until(
            expected_conditions.visibility_of_element_located(StellaBurgersLocators.SAUCES_LOCATION_BUTTON))
    ...
    def test_switch_to_filings_section(self, driver):
        ...
        driver.find_element(*StellaBurgersLocators.LOGIN_BUTTON).click()
        WebDriverWait(driver, 3).until(
            expected_conditions.visibility_of_element_located(StellaBurgersLocators.FILINGS_LOCATION_BUTTON))
